...
class ProfileView(View):
    def get(self, request, pk, *args, **kwargs):
          ...
          # Get prices for each service description
          service_prices = {}
          for service_description in service_descriptions:
               price = service_description.price
               service_prices[service_description.service.name] = price

          context = {
               'user': user,
               'profile': profile,
               'service_descriptions': service_descriptions,
               'service_prices': service_prices,  # Add service_prices to the context
          }
