...
class ProfileEditView(LoginRequiredMixin, UserPassesTestMixin, UpdateView):
     ...
     def get_success_url(self):
          ...
          return reverse_lazy('caretaker:service-description-edit', kwargs={'pk': profile_pk})
...
class ServicePriceEditView(LoginRequiredMixin, UserPassesTestMixin, UpdateView):
          ...
          def get_success_url(self):
               ...
               return reverse('caretaker:service-description-detail', kwargs={'pk': service_description_pk})
